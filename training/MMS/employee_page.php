...
<head>
  ...
  <link rel="stylesheet" href="employee_page.css?version=6">
...
<body class="container-fluid" style="background-color:rgb(219, 219, 219);overflow-x: hidden;padding:0;">
  ...
  <div class="navi ">
    ...
    <div class="navicon">
      ...
      <a href="#" class="maincont mainsub" id="medreoort"><i class="fas fa-chart-pie i_paddingright"></i> Reports</a>
  ...
  <div class="header2nd" style="position:absolute;left:50%;">
    <div class="drop-contents" style="position:relative;left:-50%;margin-left:0;z-index:1; ">
      ...
      <a href="#" class="subcont3" id="subnav-transacrecprds"><i class="fas fa-clipboard-list i_paddingright"></i></i>Check Out Records</a>
      <a href="#" class="subcont3" id="subnav-paymentrecords"><i class="fas fa-clipboard-list i_paddingright"></i></i>Payment Records</a>
  ...
  <!-- paymentrecords -->
  <div class="container mainbody paymentrecord" style="background-color:white;display:none">
    <div class="container-fluid">
      <hr>
      <h3>Payment Record</h3>
      <table class="table table-striped tblpayrec" style="padding-right:5px;padding-left:5px;text-align:center">
        <thead class="thead-dark">
  ...
  <div id="Mymodalrecords" class="transactionrecords" style="overflow:scroll">
    <!-- modal content -->
